...
DROP TABLE IF EXISTS tbl_departments CASCADE;
...
DROP TABLE IF EXISTS tbl_task_types CASCADE;
...
DROP TABLE IF EXISTS tbl_tasks_privileges CASCADE;
create table tbl_tasks_privileges(
	id serial primary key,
...
ALTER TABLE tbl_departments ADD FOREIGN KEY (manager_id) REFERENCES tbl_users(id);

ALTER TABLE tbl_users ADD FOREIGN KEY (department_id) REFERENCES tbl_departments(id);
...
ALTER TABLE tbl_tasks_privileges ADD FOREIGN KEY (task_type_id) REFERENCES tbl_task_types(id);
ALTER TABLE tbl_tasks_privileges ADD FOREIGN KEY (group_id) REFERENCES tbl_groups(id);

ALTER TABLE tbl_tasks ADD FOREIGN KEY (request_id) REFERENCES tbl_requests(id);
ALTER TABLE tbl_tasks ADD FOREIGN KEY (t_type_id) REFERENCES tbl_task_types(id);

ALTER TABLE tbl_server_contacts ADD FOREIGN KEY (server_id) REFERENCES tbl_servers(id);

ALTER TABLE tbl_servers ADD FOREIGN KEY (task_type_id) REFERENCES tbl_task_types(id);
ALTER TABLE tbl_softwares ADD FOREIGN KEY (task_type_id) REFERENCES tbl_task_types(id);
ALTER TABLE tbl_hardwares ADD FOREIGN KEY (task_type_id) REFERENCES tbl_task_types(id);
