...
-- dummy data
-- password > 123456 
insert into tbl_users(username, password, first_name, last_name, email) values 
('admin', '$2a$10$/o3dBbCgb4.nBciduYJDxOuBubMWRFK9iPGnyv3ohI3Plc3l9Qjwi' ,'admin' , 'admin' , ''),
('test1' , '$2a$10$7ck16GNSSXNq9D.CVT0cbe81mjli8CFJEdOmv1mo4RkjX93O7DfHK', 'Test1' , 'TestLastName', ''), 
('test2', '$2a$10$z6B17nmYrff0/a.61Fl/XuKTEqgENCv98ATWVv6Lvip6DbRGUnE8G' , 'Test2' , 'TestLastName' , '');

insert into tbl_module_type(name) values ('Ticket'), ('Report'), ('Finance'), ('Správa aplikácie');
...
('nedoplatok - RETAIL'),
('nedoplatok - AUTA/CKL'),
('odstúpenia/ predčasné ukončenia'),
('preplatok '),
('Storno platby'),
('Iné');
...
insert into tbl_groups(name, description, manager_id) values
('Test1 solver', 'Test group for solvers', 2),
('Test1 submit', 'Test group to submit form', 2);

insert into tbl_module_type_to_use(group_id, request_type_id) values (1,1), (2,3), (2,1) , (2,2);
insert into tbl_request_type_to_solve(group_id, request_type_id) values (1,3), (1,1), (1,2);
insert into tbl_finance_type_privileges(finance_type_id, group_id) values (4,2), (5,2), (3,2), (2,2), (1,2);
insert into tbl_ticket_privileges(group_id, ticket_type_id, application_name) values 
(1,1, 'Multicash'),
(1,1, 'Helios'),
...
insert into tbl_user_groups(user_id, group_id) values
(2,1),
(2,2),
(3,2);


insert into tbl_requests(timestamp_creation, priority_id, creator_uid, subject, position_id, type_id) values 
(now(), 2, 3 , 'Test ticket medium', 5, 1);


insert into tbl_tickets(request_id, t_type_id, t_application_name, t_request) values
(1, 1 , 'Iné', 'this is a test text this is a test text this is a test text this is a test textthis is a test text this is a test text this is a test text this is a test textthis is a test text this is a test text this is a test text this is a test textthis is a test text this is a test text this is a test text this is a test textthis is a test text this is a test text this is a test text this is a test text');