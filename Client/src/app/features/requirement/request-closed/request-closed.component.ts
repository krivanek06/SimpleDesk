...
import {RequestTableComponent} from 'app/features/requirement/components/request-table/request-table.component';
import {NgxSpinnerService} from 'ngx-spinner';
import {RequestFilterComponent} from 'app/features/requirement/components/request-filter/request-filter.component';
...
import {FilterRequests, Request} from "../../../core/model/Request";
...
export class RequestClosedComponent implements OnInit, AfterViewInit {
  private loadedRequests: Request[] = [];
  ...
  filterClosedRequests(filter: FilterRequests) {
    ...
    this.closedRequests.dataSource.data = this.closedRequests.dataSource.data as Request[];
  }
